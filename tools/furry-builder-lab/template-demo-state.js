...
(function initTemplateDemoState(globalScope, factory) {
  const api = factory();

  if (typeof module === 'object' && module.exports) module.exports = api;
  if (globalScope) globalScope.TemplateDemoState = api;
})(typeof window === 'undefined' ? null : window, function createTemplateDemoState() {
