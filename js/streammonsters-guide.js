(() => {
  ...
  const RULES_V8_COPY = {
    de: {
      ...
      dexTitle: 'Monsterdex: 24 Stream Monsters · 72 Entwicklungsstufen',
      dexLead: 'Vier Stream Monsters pro Element. Jede der 72 Entwicklungsstufen zeigt ihre echten Rules-v8-Skills A, B und C mit lokalisierten Namen und Effekten.',
    ...
    en: {
      ...
      dexTitle: 'Monsterdex: 24 Stream Monsters · 72 evolution stages',
      dexLead: 'Four Stream Monsters per element. Every one of the 72 evolution stages shows its real Rules v8 A, B and C skills with localized names and effects.',
    ...
    es: {
      ...
      dexTitle: 'Monsterdex: 24 Stream Monsters · 72 etapas de evolución',
      dexLead: 'Cuatro Stream Monsters por elemento. Cada una de las 72 etapas de evolución muestra sus habilidades reales A, B y C de Rules v8 con nombres y efectos localizados.',
    ...
    fr: {
      ...
      dexTitle: 'Monsterdex : 24 Stream Monsters · 72 stades d’évolution',
      dexLead: 'Quatre Stream Monsters par élément. Chacun des 72 stades d’évolution affiche ses vraies compétences A, B et C de Rules v8 avec des noms et effets localisés.',
  ...
  function renderMonsterDex(lang, copy) {
    return PUBLIC_CATALOG.templates.map(template => {
      const identity = [template.species, template.epithet]
        .filter(Boolean)
        .join(' · ');
