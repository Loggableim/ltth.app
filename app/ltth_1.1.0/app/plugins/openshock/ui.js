...
function openPatternModal(patternId = null) {
    ...
    if (delayInput) delayInput.value = DEFAULT_STEP_DELAY;
...
function addPatternStep() {
    ...
    const step = {
        ...
        delay: parseInt(delayInput?.value) || DEFAULT_STEP_DELAY
    };
    ...
    showNotification(`Step ${currentPatternSteps.length} added: ${step.type} @ ${step.intensity}%`, 'success');
}
