        ...
        updateGpuInfo() {
            try {
                ...
                if (gl) {
                    ...
                    // Try modern approach first (gl.RENDERER, gl.VENDOR)
                    renderer = gl.getParameter(gl.RENDERER) || 'Unknown';
                    vendor = gl.getParameter(gl.VENDOR) || 'Unknown';
                    
                    // Only use debug extension as fallback if modern approach returns generic values
                    if ((renderer === 'Unknown' || renderer.includes('WebGL')) && 
                        (vendor === 'Unknown' || vendor.includes('WebKit'))) {
