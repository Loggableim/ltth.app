...
const HTTP_RULES = Object.freeze([
  ...
  rule(['GET', 'HEAD'], pattern(/^\/api\/stream-monsters\/battles\/[A-Za-z0-9_-]+\/replay$/)),
  ...
  rule(['GET', 'HEAD'], pattern(/^\/plugins\/stream-monsters\/locales\/(?:de|en|es|fr)\.json$/)),
  rule(['GET', 'HEAD'], exact('/plugins/streamalchemy/assets/branding/stream-monsters-icon.png')),
  rule(['GET', 'HEAD'], exact('/plugins/stream-monsters/assets/branding/stream-monsters-icon.png')),
  rule(['GET', 'HEAD'], exact('/plugins/streamalchemy/assets/branding/stream-monsters-logo.png')),
  rule(['GET', 'HEAD'], exact('/plugins/stream-monsters/assets/branding/stream-monsters-logo.png')),
  rule(['GET', 'HEAD'], exact('/plugins/streamalchemy/assets/audio/manifest.json')),
  rule(['GET', 'HEAD'], exact('/plugins/stream-monsters/assets/audio/manifest.json')),
  rule(['GET', 'HEAD'], pattern(/^\/plugins\/streamalchemy\/assets\/audio\/cues\/[A-Za-z0-9._-]+\.wav$/i)),
  rule(['GET', 'HEAD'], pattern(/^\/plugins\/stream-monsters\/assets\/audio\/cues\/[A-Za-z0-9._-]+\.wav$/i)),
  rule(['GET', 'HEAD'], pattern(/^\/plugins\/streamalchemy\/assets\/eggs\/[a-z]+-(?:charged|standard)\.png$/)),
  rule(['GET', 'HEAD'], pattern(/^\/plugins\/stream-monsters\/assets\/eggs\/[a-z]+-(?:charged|standard)\.png$/)),
  rule(['GET', 'HEAD'], pattern(/^\/plugins\/streamalchemy\/assets\/streammonsters\/furry\/[a-z0-9-]+\.(?:png|webp)$/)),
  rule(['GET', 'HEAD'], pattern(/^\/plugins\/stream-monsters\/assets\/streammonsters\/furry\/[a-z0-9-]+\.(?:png|webp)$/)),
  rule(['GET', 'HEAD'], pattern(/^\/plugins\/streamalchemy\/assets\/streammonsters\/furry\/evolution\/[a-z]+\/[a-z0-9-]+-stage[23]\.(?:png|webp)$/)),
  rule(['GET', 'HEAD'], pattern(/^\/plugins\/stream-monsters\/assets\/streammonsters\/furry\/evolution\/[a-z]+\/[a-z0-9-]+-stage[23]\.(?:png|webp)$/)),
