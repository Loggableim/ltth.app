...
class ViewerXPPlugin extends EventEmitter {
  ...
  async init() {
    ...
    try {
      ...
      this.api.log('✅ Viewer XP initialized successfully', 'info');
      ...
      this.api.log(`❌ Error initializing Viewer XP: ${error.message}`, 'error');
      throw error;
    }
  }
   ...
   */
  async destroy() {
    this.api.log('Shutting down Viewer XP...', 'info');
    ...
    this.api.log('Viewer XP shut down', 'info');
  }
}
