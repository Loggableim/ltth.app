...
Das **umfassende Viewer XP-Bundle** mit integrierter **Echtzeit-Gifter-Bestenliste** und den **Viewer Profiles Analytics** - alles in einem konsolidierten Plugin.
...
### **Viewer XP** (mit integrierter Gifter-Bestenliste)
...
Viewer XP registriert folgende Chat-Befehle:
...
### Viewer XP Features (Basisversion)
...
- **Viewer XP** (v1.0.0) mit integrierter Gifter-Bestenliste

Das Standalone **Gifter Leaderboard** Plugin (v1.1.0) wurde in Viewer XP integriert und ist als eigenständiges Plugin veraltet.
