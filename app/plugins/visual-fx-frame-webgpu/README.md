...
Version `1.2.0` ships with LTTH as a disabled-by-default runtime beta and remains available as a subscriber open-beta Plugin Store package. It requires a WebGPU-capable OBS browser source; the original `flame-overlay` plugin remains unchanged.
