...
Das **Spotlight** Plugin bietet permanente Live-Overlays, die jeweils den zuletzt aktiven Nutzer für verschiedene Event-Typen anzeigen. Perfekt für OBS, LIVE Studio und andere Streaming-Software.
...
1. Das Plugin befindet sich bereits im `/plugins/spotlight` Verzeichnis
2. Aktivieren Sie das Plugin im Plugin-Manager
3. Navigieren Sie zur Plugin-UI unter `/spotlight/ui`
...
```
/overlay/spotlight/follower
/overlay/spotlight/like
/overlay/spotlight/chatter
/overlay/spotlight/share
/overlay/spotlight/gifter
/overlay/spotlight/subscriber
/overlay/spotlight/topgift
/overlay/spotlight/giftstreak
/overlay/spotlight/multihud
```
...
Öffnen Sie die Plugin-Verwaltung und navigieren Sie zum "Spotlight" Tab.
