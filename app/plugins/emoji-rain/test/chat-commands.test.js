/**
 * Tests for EmojiRain chat command eligibility and emitted plain-rain payloads.
 */
...
class MockAPI {
  ...
  getPluginDataDir() {
    return '/tmp/emoji-rain-chat-command-test';
  }
  ...
  getConfigPathManager() {
    return {
      getUserConfigsDir: () => '/tmp/emoji-rain-chat-command-config'
    };
  }
...
describe('EmojiRain chat commands', () => {
  let EmojiRainPlugin;
