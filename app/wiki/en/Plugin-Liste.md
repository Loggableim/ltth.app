...
**Integration:** When GCCE is available, it is the sole command ingress. Prefix and aliases are editable and conflict-checked; overlay hints use the active configuration and never send chat messages.
