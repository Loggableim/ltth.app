...
switch (os.platform()) {
    case 'win32':
        if (defaultConfigDir.includes('AppData\\Local\\ltth.app')) {
        ...
        break;
    case 'darwin':
        if (defaultConfigDir.includes('Library/Application Support/ltth.app')) {
        ...
        break;
    case 'linux':
        if (defaultConfigDir.includes('.local/share/ltth.app')) {
