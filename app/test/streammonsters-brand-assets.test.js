...
describe('Stream Monsters public branding', () => {
  it('uses generated Stream Monsters assets while retaining the stable plugin ID', async () => {
    ...
    expect(docsPage).toContain('Stream Monsters');
    ...
    expect(pluginManifest.version).toBe('1.4.0');
    ...
    expect(streamMonsters.packageUrl).toBe('https://ltth.app/plugin-store/packages/streamalchemy-1.4.0.zip');
