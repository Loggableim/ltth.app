...
(() => {
    ...
    function initializeShortcuts() {
        ...
        const shortcuts = [
            ...
            { icon: 'zap', label: 'EmojiRain', view: 'emoji-rain', plugin: 'emoji-rain' },
            { icon: 'sparkles', label: 'WebGPU EmojiRain', view: 'webgpu-emoji-rain', plugin: 'webgpu-emoji-rain' },
