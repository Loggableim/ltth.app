...
class SoundboardManager extends EventEmitter {
    ...
    normalizeGiftEvent(giftData = {}) {
        ...
        const repeatCount = Math.max(this._positiveInt(this._firstValue(
     ...
     * repeatCount is TikTok gift metadata, not an instruction to replay audio.
     * Queue and overlap behavior is handled by the frontend play mode.
     */
