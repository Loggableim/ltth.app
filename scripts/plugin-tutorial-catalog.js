...
const ROUTES = {
  ...
  goals: ['/dashboard.html?view=plugins', '/goals/ui', '/goals/ui', '/goals/overlay'],
...
const PROFILES = {
  ...
  system: ['api-bridge', 'config-import', 'gcce', 'gift-catalog', 'milestone-leaderboard', 'sidekick', 'store-admin']
};
