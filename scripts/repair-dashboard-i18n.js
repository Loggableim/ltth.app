...
const entries = {
  ...
  settings: {
    ...
    websocket_hint: { en: 'Default: 21213. Change only if TikFinity uses a different port.', de: 'Standard: 21213. Nur ändern, wenn TikFinity einen anderen Port verwendet.', es: 'Predeterminado: 21213. Cámbialo solo si TikFinity usa otro puerto.', fr: 'Par défaut : 21213. À modifier uniquement si TikFinity utilise un autre port.' },
    ...
    tikfinity_title: { en: '🔗 TikFinity', de: '🔗 TikFinity', es: '🔗 TikFinity', fr: '🔗 TikFinity' },
    tikfinity_desc: { en: 'Connection through the TikFinity desktop app (local WebSocket)', de: 'Verbindung über die TikFinity-Desktop-App (lokaler WebSocket)', es: 'Conexión mediante la aplicación de escritorio TikFinity (WebSocket local)', fr: 'Connexion via l’application de bureau TikFinity (WebSocket local)' },
...
const replacements = new Map([
  ...
  ['<span>🔗 TikFinity</span>', '<span data-i18n="settings.tikfinity_title">🔗 TikFinity</span>'],
  ['<p class="text-xs text-gray-400 mt-0.5">Verbindung über TikFinity Desktop App (lokaler WebSocket)</p>', '<p class="text-xs text-gray-400 mt-0.5" data-i18n="settings.tikfinity_desc">Verbindung über die TikFinity-Desktop-App (lokaler WebSocket)</p>'],
  ['<label>WebSocket Port</label>', '<label data-i18n="settings.websocket_port">WebSocket Port</label>'],
  ['<p class="text-xs text-gray-500 mt-1">Standard: 21213. Nur ändern wenn in TikFinity ein anderer Port konfiguriert ist.</p>', '<p class="text-xs text-gray-500 mt-1" data-i18n="settings.websocket_hint">Standard: 21213. Nur ändern, wenn TikFinity einen anderen Port verwendet.</p>'],
