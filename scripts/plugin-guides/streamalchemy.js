...
// Complete editorial and workflow contract for Stream Monsters 1.10. The
...
module.exports = Object.freeze({
  ...
  test: {
    de: 'die lokale Stream-Monsters-1.9-Vorschau',
    en: 'the local Stream Monsters 1.10 preview',
    es: 'la vista previa local de Stream Monsters 1.10',
    fr: 'l’aperçu local de Stream Monsters 1.10'
  },
  expected: {
  ...
  copy: {
    de: {
      ...
      summary: 'Stream Monsters 1.10 verbindet vom Creator aktivierte Gift-Eier, optionale wiederkehrende Gratis-Eier, 72 gebündelte Furry-Formen, permanente Entwicklung und verdeckte A/B/C-Duelle in einer Portrait-first-Arena.',
      ...
      requirements: 'LTTH 1.4.1 mit Stream Monsters 1.10. Für den lokalen Aufbau genügt der Creator; TikTok, GCCE und OBS werden erst für den Sendebetrieb benötigt.',
      safety: 'Verwende nur lokale Vorschauen. Gratis-Eier und Gifts verändern keine Kampfwerte oder Gewinnchancen. Stream Monsters 1.10 enthält kein Art Lab, keine Bildgenerierung und keinen Modell-Installer.',
    ...
    en: {
      title: 'Stream Monsters',
      summary: 'Stream Monsters 1.10 combines creator-enabled gift eggs, optional recurring free eggs, 72 bundled Furry forms, permanent progression, and sealed A/B/C battles in a portrait-first arena.',
      ...
      requirements: 'LTTH 1.4.1 with Stream Monsters 1.10. The Creator is enough for local setup; TikTok, GCCE, and OBS are needed only for broadcast operation.',
      safety: 'Use local previews only while checking the setup. Free eggs and gifts never change combat stats or win odds. Stream Monsters 1.10 includes no Art Lab, image generation, or model installer.',
    ...
    es: {
      title: 'Stream Monsters',
      summary: 'Stream Monsters 1.10 combina huevos por regalos activados por el creador, huevos gratis periódicos opcionales, 72 formas Furry incluidas, progreso permanente y combates A/B/C sellados en una arena vertical.',
      ...
      requirements: 'LTTH 1.4.1 con Stream Monsters 1.10. Creator basta para la configuración local; TikTok, GCCE y OBS solo son necesarios para emitir.',
      safety: 'Usa únicamente vistas previas locales. Los huevos gratis y los regalos nunca cambian estadísticas ni probabilidades de victoria. Stream Monsters 1.10 no incluye Art Lab, generación de imágenes ni instalador de modelos.',
    ...
    fr: {
      title: 'Stream Monsters',
      summary: 'Stream Monsters 1.10 réunit les œufs issus des cadeaux activés par le Creator, des œufs gratuits récurrents facultatifs, 72 formes Furry, une progression permanente et des combats A/B/C scellés dans une arène portrait.',
      ...
      requirements: 'LTTH 1.4.1 avec Stream Monsters 1.10. Le Creator suffit pour la configuration locale ; TikTok, GCCE et OBS ne sont nécessaires que pour la diffusion.',
      safety: 'Utilisez uniquement les aperçus locaux. Les œufs gratuits et cadeaux ne modifient jamais les statistiques ni les chances de victoire. Stream Monsters 1.10 ne comprend ni Art Lab, ni génération d’images, ni installateur de modèles.',
  ...
  steps: [
    readOnlyStep('alchemy-card', '#live-center', {
      de: {
        ...
        alt: 'Stream Monsters 1.10 Live Center mit Broadcast-Status'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.10 Live Center with broadcast status'
      },
      es: {
        ...
        alt: 'Live Center de Stream Monsters 1.10 con estado de emisión'
      },
      fr: {
        ...
        alt: 'Live Center de Stream Monsters 1.10 avec état de diffusion'
      }
    }),
    readOnlyStep('retention-rules', '#gameplay', {
      de: {
        ...
        alt: 'Stream Monsters 1.10 Gameplay mit Gratis-Eiern und verdeckten Entscheidungen'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.10 gameplay with free eggs and sealed choices'
      },
      es: {
        ...
        alt: 'Gameplay de Stream Monsters 1.10 con huevos gratis y elecciones selladas'
      },
      fr: {
        ...
        alt: 'Gameplay Stream Monsters 1.10 avec œufs gratuits et choix scellés'
      }
    }),
    readOnlyStep('automation-rule', '#gifts-chat', {
      de: {
        ...
        alt: 'Stream Monsters 1.10 Geschenk-Eier, optionale Gratis-Eier und Chat-Aliase'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.10 gift eggs, optional free eggs, and chat aliases'
      },
      es: {
        ...
        alt: 'Huevos de regalos, huevos gratis opcionales y alias en Stream Monsters 1.10'
      },
      fr: {
        ...
        alt: 'Œufs-cadeaux, œufs gratuits facultatifs et alias dans Stream Monsters 1.10'
      }
    }),
    readOnlyStep('action-chain', '#asset-library', {
      de: {
        ...
        alt: 'Stream Monsters 1.10 Asset-Bibliothek mit 72 Furry-Formen'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.10 asset library with 72 Furry forms'
      },
      es: {
        ...
        alt: 'Biblioteca de Stream Monsters 1.10 con 72 formas Furry'
      },
      fr: {
        ...
        alt: 'Bibliothèque Stream Monsters 1.10 avec 72 formes Furry'
      }
    }),
    readOnlyStep('rule-dry-run', '#portraitStagePreview', {
      de: {
        ...
        alt: 'Stream Monsters 1.10 Portrait-Arena mit A/B/C-Aktionen'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.10 portrait arena with A/B/C actions'
      },
      es: {
        ...
        alt: 'Arena vertical de Stream Monsters 1.10 con acciones A/B/C'
      },
      fr: {
        ...
        alt: 'Arène portrait Stream Monsters 1.10 avec actions A/B/C'
      }
    }),
    readOnlyStep('alchemy-overlay', '#overlayUrl', {
      de: {
        ...
        alt: 'Stream Monsters 1.10 OBS-Overlay-URL und Portrait-Vorschau'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.10 OBS overlay URL and portrait preview'
      },
      es: {
        ...
        alt: 'URL del overlay OBS y vista vertical de Stream Monsters 1.10'
      },
      fr: {
        ...
        alt: 'URL de l’overlay OBS et aperçu portrait de Stream Monsters 1.10'
      }
    }),
    readOnlyStep('rule-reset', '#community-seasons', {
      de: {
        ...
        alt: 'Stream Monsters 1.10 Community- und Saisonansicht'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.10 community and season view'
      },
      es: {
        ...
        alt: 'Vista de comunidad y temporadas de Stream Monsters 1.10'
      },
      fr: {
        ...
        alt: 'Vue Communauté et saisons de Stream Monsters 1.10'
      }
    })
  ]
});
