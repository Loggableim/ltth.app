...
const UI_ROUTE = '/stream-monsters/ui';
const OVERLAY_ROUTE = '/stream-monsters/overlay';
...
// Complete editorial and workflow contract for Stream Monsters 1.12. The
...
module.exports = Object.freeze({
  ...
  test: {
    de: 'die lokale Stream-Monsters-1.12-Vorschau',
    en: 'the local Stream Monsters 1.12 preview',
    es: 'la vista previa local de Stream Monsters 1.12',
    fr: 'l’aperçu local de Stream Monsters 1.12'
  },
  expected: {
  ...
  copy: {
    de: {
      ...
      summary: `Stream Monsters 1.12 verbindet Gift- und optionale Gratis-Eier, 72 gebündelte Furry-Formen, zweisprachige Overlay-Führung und K.-o.-Duelle nach Rules v8 in der TikTok-sicheren 74/26-Portrait-Arena ${PRODUCT_PROJECTION.arenaLabel}.`,
      ...
      requirements: `LTTH 1.4.2 mit Stream Monsters 1.12. Für den lokalen Aufbau genügt der Creator; TikTok, GCCE und OBS werden erst für den Sendebetrieb benötigt. ${PRODUCT_PROJECTION.access.description.de}`,
      safety: 'Verwende nur lokale Vorschauen. Gratis-Eier und Gifts verändern keine Kampfwerte oder Gewinnchancen. Stream Monsters 1.12 enthält kein Art Lab, keine Bildgenerierung und keinen Modell-Installer.',
      troubleshooting: 'Wenn Gifts, 72 Formen oder die A/B/C-Vorschau fehlen, prüfe den Plugin-Status, öffne /stream-monsters/ui neu und kontrolliere die Hinweise im Live Center.',
      related: ['gcce', 'gift-catalog']
    },
    en: {
      title: 'Stream Monsters',
      summary: `Stream Monsters 1.12 combines gift and optional free eggs, 72 bundled Furry forms, bilingual overlay guidance, and sealed Rules v8 K.O. battles in the TikTok-safe 74/26 portrait ${PRODUCT_PROJECTION.arenaLabel} arena.`,
      ...
      requirements: `LTTH 1.4.2 with Stream Monsters 1.12. The Creator is enough for local setup; TikTok, GCCE, and OBS are needed only for broadcast operation. ${PRODUCT_PROJECTION.access.description.en}`,
      safety: 'Use local previews only while checking the setup. Free eggs and gifts never change combat stats or win odds. Stream Monsters 1.12 includes no Art Lab, image generation, or model installer.',
      troubleshooting: 'If gifts, the 72 forms, or the A/B/C preview are missing, check the plugin status, reopen /stream-monsters/ui, and review the Live Center warnings.',
      related: ['gcce', 'gift-catalog']
    },
    es: {
      title: 'Stream Monsters',
      summary: `Stream Monsters 1.12 combina huevos por regalos y gratis opcionales, 72 formas Furry, guía bilingüe y combates Rules v8 hasta K.O. en la arena vertical 74/26 ${PRODUCT_PROJECTION.arenaLabel}, segura para TikTok.`,
      ...
      requirements: `LTTH 1.4.2 con Stream Monsters 1.12. Creator basta para la configuración local; TikTok, GCCE y OBS solo son necesarios para emitir. ${PRODUCT_PROJECTION.access.description.es}`,
      safety: 'Usa únicamente vistas previas locales. Los huevos gratis y los regalos nunca cambian estadísticas ni probabilidades de victoria. Stream Monsters 1.12 no incluye Art Lab, generación de imágenes ni instalador de modelos.',
      troubleshooting: 'Si faltan los regalos, las 72 formas o la vista previa A/B/C, comprueba el estado del plugin, vuelve a abrir /stream-monsters/ui y revisa los avisos de Live Center.',
      related: ['gcce', 'gift-catalog']
    },
    fr: {
      title: 'Stream Monsters',
      summary: `Stream Monsters 1.12 réunit les œufs-cadeaux et gratuits facultatifs, 72 formes Furry, un guide bilingue et des combats Rules v8 jusqu’au K.-O. dans l’arène portrait TikTok 74/26 ${PRODUCT_PROJECTION.arenaLabel}.`,
      ...
      requirements: `LTTH 1.4.2 avec Stream Monsters 1.12. Le Creator suffit pour la configuration locale ; TikTok, GCCE et OBS ne sont nécessaires que pour la diffusion. ${PRODUCT_PROJECTION.access.description.fr}`,
      safety: 'Utilisez uniquement les aperçus locaux. Les œufs gratuits et cadeaux ne modifient jamais les statistiques ni les chances de victoire. Stream Monsters 1.12 ne comprend ni Art Lab, ni génération d’images, ni installateur de modèles.',
      troubleshooting: 'Si les cadeaux, les 72 formes ou l’aperçu A/B/C manquent, vérifiez l’état du plugin, rouvrez /stream-monsters/ui et consultez les avertissements du Live Center.',
      related: ['gcce', 'gift-catalog']
    }
  },
  steps: [
    readOnlyStep('alchemy-card', '#live-center', {
      de: {
        ...
        alt: 'Stream Monsters 1.12 Live Center mit Broadcast-Status'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.12 Live Center with broadcast status'
      },
      es: {
        ...
        alt: 'Live Center de Stream Monsters 1.12 con estado de emisión'
      },
      fr: {
        ...
        alt: 'Live Center de Stream Monsters 1.12 avec état de diffusion'
      }
    }),
    readOnlyStep('retention-rules', '#gameplay', {
      de: {
        ...
        alt: 'Stream Monsters 1.12 Gameplay mit Gratis-Eiern und verdeckten Entscheidungen'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.12 gameplay with free eggs and sealed choices'
      },
      es: {
        ...
        alt: 'Gameplay de Stream Monsters 1.12 con huevos gratis y elecciones selladas'
      },
      fr: {
        ...
        alt: 'Gameplay Stream Monsters 1.12 avec œufs gratuits et choix scellés'
      }
    }),
    readOnlyStep('automation-rule', '#gifts-chat', {
      de: {
        ...
        alt: 'Stream Monsters 1.12 Geschenk-Eier, optionale Gratis-Eier und Chat-Aliase'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.12 gift eggs, optional free eggs, and chat aliases'
      },
      es: {
        ...
        alt: 'Huevos de regalos, huevos gratis opcionales y alias en Stream Monsters 1.12'
      },
      fr: {
        ...
        alt: 'Œufs-cadeaux, œufs gratuits facultatifs et alias dans Stream Monsters 1.12'
      }
    }),
    ...
    readOnlyStep('rule-dry-run', '#portraitBattlePreview', {
      de: {
        ...
        alt: 'Stream Monsters 1.12 Portrait-Arena mit A/B/C-Aktionen'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.12 portrait arena with A/B/C actions'
      },
      es: {
        ...
        alt: 'Arena vertical de Stream Monsters 1.12 con acciones A/B/C'
      },
      fr: {
        ...
        alt: 'Arène portrait Stream Monsters 1.12 avec actions A/B/C'
      }
    }),
    readOnlyStep('alchemy-overlay', '#overlayUrl', {
      de: {
        title: 'Stream-Monsters-Overlay in OBS eintragen',
        body: 'Kopiere /stream-monsters/overlay in eine OBS-Browserquelle. Wähle Portrait 1080×1920 oder Landscape 1920×1080 und prüfe Renderer-Qualität, Safe-Zone und die fünf Audio-Kanäle mit einer lokalen Demo.',
        expected: 'Die echte Overlay-URL und alle Broadcast-Vorschauen sind im Creator sichtbar.',
        alt: 'Stream Monsters 1.12 OBS-Overlay-URL und Portrait-Vorschau'
      },
      en: {
        title: 'Add the Stream Monsters overlay to OBS',
        body: 'Copy /stream-monsters/overlay into an OBS browser source. Choose portrait 1080×1920 or landscape 1920×1080, then review renderer quality, safe zones, and the five audio channels with a local demo.',
        expected: 'The real overlay URL and every broadcast preview are visible in the Creator.',
        alt: 'Stream Monsters 1.12 OBS overlay URL and portrait preview'
      },
      es: {
        title: 'Añade el overlay de Stream Monsters a OBS',
        body: 'Copia /stream-monsters/overlay en una fuente de navegador de OBS. Elige vertical 1080×1920 u horizontal 1920×1080 y comprueba la calidad del renderizador, las zonas seguras y los cinco canales de audio con una demo local.',
        expected: 'La URL real del overlay y todas las vistas de emisión son visibles en Creator.',
        alt: 'URL del overlay OBS y vista vertical de Stream Monsters 1.12'
      },
      fr: {
        title: 'Ajoutez l’overlay Stream Monsters à OBS',
        body: 'Copiez /stream-monsters/overlay dans une source navigateur OBS. Choisissez le portrait 1080×1920 ou le paysage 1920×1080, puis vérifiez la qualité du rendu, les zones sûres et les cinq canaux audio avec une démo locale.',
        expected: 'L’URL réelle de l’overlay et tous les aperçus de diffusion sont visibles dans le Creator.',
        alt: 'URL de l’overlay OBS et aperçu portrait de Stream Monsters 1.12'
      }
    }),
    readOnlyStep('rule-reset', '#community-seasons', {
      de: {
        ...
        alt: 'Stream Monsters 1.12 Community- und Saisonansicht'
      },
      en: {
        ...
        alt: 'Stream Monsters 1.12 community and season view'
      },
      es: {
        ...
        alt: 'Vista de comunidad y temporadas de Stream Monsters 1.12'
      },
      fr: {
        ...
        alt: 'Vue Communauté et saisons de Stream Monsters 1.12'
      }
    })
  ]
});
